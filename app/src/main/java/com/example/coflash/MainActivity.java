                        ...
                        public void onComplete(Task<DataSnapshot> task) {
                            if (!task.isSuccessful()) {
                                ...
                                if(task.getResult().child("name").getValue()==null){//沒註冊過的人，幫他建立資料庫
                                    ...
                                    myRef.child("user").child(uid).child("activity").child("id").setValue("0");
                                    ...
                                    myRef.child("user").child(uid).child("mission").child("1").setValue("false");
                                    myRef.child("user").child(uid).child("mission").child("2").setValue("false");
                                    myRef.child("user").child(uid).child("mission").child("2").setValue("false");
                                    myRef.child("user").child(uid).child("tag").child("id").setValue("0");
                                    myRef.child("user").child(uid).child("notice").child("collect_id").setValue("0");
                                    myRef.child("user").child(uid).child("position").child("id").setValue("0");
                                }
                            }
                        }
                    });
